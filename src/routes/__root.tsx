...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Magic Studio — AI Reel Generator" },
      { name: "description", content: "Create glam, cinematic, anime, and retro AI reels from your photos." },
      { property: "og:title", content: "Magic Studio — AI Reel Generator" },
